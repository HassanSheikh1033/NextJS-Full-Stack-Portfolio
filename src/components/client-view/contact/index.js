                ...
                controlItem.name === "message" ? (
                  <div className="p-2 w-full">
                    <div className="relative">
                      <label className="text-sm text-[#d2d2d2]">
                        {controlItem.label}
                      </label>
                      <textarea
                        id={controlItem.name}
                        ...
                        className="w-full border-[#898688] border-[2px] bg-[#b5b3b5] rounded  h-32 text-base outline-none text-[#000000] py-1 px-3 resize-none leading-6"
                      ></textarea>
                    </div>
                  </div>
                ) : (
                  <div className="p-2 w-full">
                    <div className="relative">
                      <label className="text-sm text-[#cfc2cd]">
                        {controlItem.label}
                      </label>
                      <input
                        id={controlItem.name}
                        ...
                        className="w-full border-[#898688] border-[2px] bg-[#b5b3b5] rounded  text-base outline-none text-[#000000] py-1 px-3 leading-6"
                      />
                    </div>
                  </div>
                )
