...
import aiImage from "../../../assets/ai2-preview.png";
...
const socialIcons = [
  ...
  },
  {
    id: "twitter",
    icon: (
      <FaTwitter color="rgb(164, 16, 157)" className="w-[40px] h-[40px] " />
    ),
  },
  {
    id: "linkedin",
        ...
        >
          ...
          <motion.div ref={containerRef} className="flex w-full justify-end">
            <motion.div
              ...
              className="w-[400px] h-[400px] relative bg-[#741574]"
            >
              <div className="w-[400px] h-[400px] top-[40px] left-[-30px] rounded-lg border-[6px] border-[#3b0f38] absolute"></div>
              <Image
                src={aiImage}
                alt="Profile Picture"
                layout="responsive"
